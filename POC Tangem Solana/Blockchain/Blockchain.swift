...
class Blockchain {
    ...
    func xyz() {
        ...
        //            url: URL(string: "https://light-still-yard.solana-devnet.quiknode.pro/656227547c592e74f178b3e62ee9b6b51f515292/")!,
        //            urlWebSocket: URL(string: "wss://light-still-yard.solana-devnet.quiknode.pro/656227547c592e74f178b3e62ee9b6b51f515292/")!,
        //            network: .devnet
        //        )
        ...
        Task {
            ...
            do {
                ...
                let blockhash = try await solana.api.getRecentBlockhash()
